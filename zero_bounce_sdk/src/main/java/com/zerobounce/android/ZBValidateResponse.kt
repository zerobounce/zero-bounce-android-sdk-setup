...
data class ZBValidateResponse(
    ...
    @SerializedName("status") val status: ZBValidateStatus? = null,
    ...
    @SerializedName("sub_status") val subStatus: ZBValidateSubStatus? = null,
    ...
    @SerializedName("domain_age_days") val domainAgeDays: String? = null,

    //[true/false] If the email comes from a free provider.
    @SerializedName("free_email") val freeEmail: Boolean = false,

    //[true/false] Does the domain have an MX record.
    @SerializedName("mx_found") val mxFound: Boolean = false,

    //The preferred MX record of the domain
    @SerializedName("mx_record") val mxRecord: String? = null,

    //The SMTP Provider of the email or [null] [BETA].
    @SerializedName("smtp_provider") val smtpProvider: String? = null,
    ...
    @SerializedName("processed_at") val processedAt: Date? = null,
